...
public class BMatchNoArgsImpl extends ASTWrapperPsiElement implements BMatchNoArgs {

  public BMatchNoArgsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BVisitor visitor) {
    visitor.visitMatchNoArgs(this);
  }
