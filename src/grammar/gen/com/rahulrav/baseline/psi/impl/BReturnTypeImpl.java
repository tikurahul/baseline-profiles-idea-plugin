...
public class BReturnTypeImpl extends ASTWrapperPsiElement implements BReturnType {

  public BReturnTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public BType getType() {
    return findChildByClass(BType.class);
  }
