...
public class BMatchAllArgsImpl extends ASTWrapperPsiElement implements BMatchAllArgs {

  public BMatchAllArgsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BVisitor visitor) {
    visitor.visitMatchAllArgs(this);
  }
