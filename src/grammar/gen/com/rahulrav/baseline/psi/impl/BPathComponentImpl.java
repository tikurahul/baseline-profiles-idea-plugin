...
public class BPathComponentImpl extends ASTWrapperPsiElement implements BPathComponent {

  public BPathComponentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<BComponent> getComponentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BComponent.class);
  }
