...
public class BTypeImpl extends ASTWrapperPsiElement implements BType {

  public BTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public BArrayRule getArrayRule() {
    return findChildByClass(BArrayRule.class);
  }
