...
public class BClassPrefixImpl extends ASTWrapperPsiElement implements BClassPrefix {

  public BClassPrefixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BVisitor visitor) {
    visitor.visitClassPrefix(this);
  }
